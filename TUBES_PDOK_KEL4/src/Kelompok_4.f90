PROGRAM KELOMPOK_4
      ...
      INTEGER :: M_IN
      REAL :: V_OUT_SAL, V_OUT_SVAN, V_OUT_DEPTH, V_OUT_TF
      ...
      PRINT *, "INPUT: Mode SAL78 (0=Cond->Sal, 1=Sal->Cond):"
      READ *, M_IN
      IF (M_IN .EQ. 0) THEN
          PRINT *, "INPUT: Conductivity Ratio:"
          READ *, CND_IN
          V_OUT_SAL = SAL78(CND_IN, T_IN, P_IN, 0)
          PRINT *, ">> Salinity                   : ", V_OUT_SAL
      ELSE
          PRINT *, "Using initial Salinity input..."
          V_OUT_SAL = SAL78(S_IN, T_IN, P_IN, 1)
          PRINT *, ">> Conductivity Ratio         : ", V_OUT_SAL
      END IF
